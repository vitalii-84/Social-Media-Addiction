...
5.  **Гіпотеза 5 (Навчання):** Високий рівень залежності (`Addicted_Score` > 7) у 100% випадків негативно впливає на самооцінку успішності.
6.  **Гіпотеза 6 (Соціальний захист):** Стабільні стосунки ("In Relationship") діють як захисний фактор, знижуючи середній рівень залежності.
