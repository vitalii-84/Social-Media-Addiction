...
if page == "Головна":
    ...
    with tab1:
        ...
        st.success("**Висновок:** Чітка негативна кореляція. Зростання екранного часу безпосередньо веде до скорочення тривалості сну.")
    ...
    with tab3:
        ...
        st.success("**Вердикт:** Статус 'Complicated' корелює з найвищою частотою використання соцмереж, тоді як стабільні стосунки часто є стримуючим фактором.")
    ...
    st.info("У наступному кроці ми додамо сюди інтерактивну карту світу.")

elif page == "ML Діагностика":
    st.title("🤖 Машинне навчання: Перевір себе")
    st.info("Тут буде реалізовано алгоритм кластеризації для вашої самоперевірки.")
