...
if page == "Головна":
    ...
    # Рахуємо середній бал для кожної країни (для візуалізації на карті)
    ...
    fig_map.update_layout(
        geo=dict(
            showframe=False,
            showcoastlines=True,
            projection_type='natural earth' # Більш сучасний вигляд карти
        ),
    ...
    st.subheader("Гіпотеза 7: Регіональні відмінності")
    
    # Використовуємо вже готову в DataLab колонку 'Region'
    ...
    fig_region = px.bar(
        ...
        orientation='h',
        color="Addicted_Score",
        text_auto='.2f', # Показуємо цифри прямо на стовпчиках
    ...
    st.success("""
    **Вердикт:** Гіпотеза 7 частково підтверджена. Ми спостерігаємо найвищі рівні цифрової залежності 
    в регіонах з інтенсивним розвитком IT-інфраструктури (Північна Америка), тоді як в Європі 
    показники є більш збалансованими.
    """)
